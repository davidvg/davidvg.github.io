...
BLOG_AUTHOR = "David Vázquez"  # (translatable)
BLOG_TITLE = "Muerte por Checklist"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://davidvg.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://davidvg.github.io/"
BLOG_EMAIL = "david.vazquezgijon@gmail.com"
BLOG_DESCRIPTION = "Blog personal - barra - cajón desastre"  # (translatable)
